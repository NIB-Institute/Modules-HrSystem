...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::index
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:77
* @route '/dashboard/inventories/trash'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/dashboard/inventories/trash',
...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::restore
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:128
* @route '/dashboard/inventories/{uuid}/restore'
*/
...
restore.definition = {
    methods: ["put"],
    url: '/dashboard/inventories/{uuid}/restore',
...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::forceDelete
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:143
* @route '/dashboard/inventories/{uuid}/force-delete'
*/
...
forceDelete.definition = {
    methods: ["delete"],
    url: '/dashboard/inventories/{uuid}/force-delete',
...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::empty
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:158
* @route '/dashboard/inventories/trash/empty'
*/
...
empty.definition = {
    methods: ["delete"],
    url: '/dashboard/inventories/trash/empty',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::bulkRestore
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:173
* @route '/dashboard/inventories/trash/bulk-restore'
*/
...
bulkRestore.definition = {
    methods: ["put"],
    url: '/dashboard/inventories/trash/bulk-restore',
} satisfies RouteDefinition<["put"]>
...
/**
* @see \Modules\School\Http\Controllers\Dashboard\V1\InventoryTrashController::bulkForceDelete
* @see Modules/School/app/Http/Controllers/Dashboard/V1/InventoryTrashController.php:196
* @route '/dashboard/inventories/trash/bulk-force-delete'
*/
...
bulkForceDelete.definition = {
    methods: ["delete"],
    url: '/dashboard/inventories/trash/bulk-force-delete',
} satisfies RouteDefinition<["delete"]>
...
const InventoryTrashController = { index, restore, forceDelete, empty, bulkRestore, bulkForceDelete }

export default InventoryTrashController