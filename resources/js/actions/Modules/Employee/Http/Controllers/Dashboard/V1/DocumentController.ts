...
update029a589f4896ca1ceb5db39344d51307.definition = {
    methods: ["put"],
...
update029a589f4896ca1ceb5db39344d51307.url = (args: { document: string | { uuid: string } } | [document: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    ...
    return update029a589f4896ca1ceb5db39344d51307.definition.url
            .replace('{document}', parsedArgs.document.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
const DocumentController = { create, store, index, edit, update, download, confirmDelete, destroy }
