...
const isSystemRole = computed(() => {
    return ['super-admin', 'admin', 'manager', 'staff', 'employee', 'viewer'].includes(props.role.name);
});
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl font-bold tracking-tight flex items-center gap-2">
                        ...
                        Edit Role: <span class="capitalize">{{ role.name.replace(/-/g, ' ') }}</span>
                    </h1>
            ...
            <form @submit.prevent="handleSubmit">
                <div class="grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <!-- Super Admin Warning -->
                        <Card v-if="role.name === 'super-admin'" class="border-amber-500/50 bg-amber-500/5">
                            <CardContent class="flex items-center gap-3 pt-6">
                                <Crown class="h-5 w-5 text-amber-500" />
                                <p class="text-sm text-amber-700 dark:text-amber-400">
                                    The super-admin role has full access to all permissions and cannot be modified.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div class="space-y-2">
                                    ...
                                    <p v-if="isSystemRole && role.name !== 'super-admin'" class="text-sm text-muted-foreground flex items-center gap-1">
                                        <AlertTriangle class="h-3.5 w-3.5" />
                                        This is a system role. Changing the name may affect system functionality.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <!-- Permissions -->
                        <Card v-if="role.name !== 'super-admin'">
                        ...
                        <Card class="sticky top-6">
                            ...
                            <CardContent class="space-y-4">
                                ...
                                <div class="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                                    ...
                                    <div>
                                        <p class="font-medium capitalize">{{ role.name.replace(/-/g, ' ') }}</p>
                                ...
                                <!-- Progress (only for non-super-admin) -->
                                <div v-if="role.name !== 'super-admin'" class="space-y-2">
                                ...
                                <!-- Selected Modules -->
                                <div v-if="role.name !== 'super-admin'" class="space-y-3">
