        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="space-y-8">
                <div v-for="(widgets, module) in groupedWidgets" :key="module" class="space-y-4">
                    ...
                    <VueDraggable v-model="groupedWidgets[module as string]" :class="[viewMode === 'grid' ? 'grid gap-4 md:grid-cols-2 lg:grid-cols-3' : 'flex flex-col gap-3']" ghost-class="opacity-50" :animation="200" @end="() => handleDragEnd(module as string)">
                        <div v-for="widget in groupedWidgets[module as string]" :key="widget.id" class="cursor-grab active:cursor-grabbing">
                            <Card class="relative group">
                                <div class="absolute left-2 top-1/2 -translate-y-1/2 opacity-60 group-hover:opacity-100 transition-opacity pointer-events-none">
