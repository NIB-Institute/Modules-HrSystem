...
/**
 * Shared modal page rendered by every controller that uses
 * App\Concerns\Exports\ExportsResources. Each module's exportOptions()
 * returns:
 *
 *   Inertia::modal('shared/ResourceExportPage', [
 *     'exportColumns' => ...,
 *     'exportRoute'   => route('xxx.export'),
 *     'title'         => 'Export Employees',
 *   ])->baseRoute('xxx.index');
 *
 * No per-module Vue file needed.
 */
...
const props = withDefaults(
    ...
    {
        title: 'Export',
        description: 'Choose the columns and format for your file.',
    },
);
...
const handleSubmit = () => {
    ...
    window.location.assign(`${props.exportRoute}?${params.toString()}`);
