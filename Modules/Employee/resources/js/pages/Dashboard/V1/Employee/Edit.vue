...
const form = useForm<EmployeeFormData>({
    ...
    id_card_number: props.employee.id_card_number || '',
    id_card_front_url: props.employee.id_card_front_url || '',
    ...
    confirmation_date: props.employee.confirmation_date || '',
...
const getFormData = () => ({
    ...
    id_card_front_url: form.id_card_front_url || null,
