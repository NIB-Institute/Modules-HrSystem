...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_card_number' => ['nullable', 'string', 'max:50', Rule::unique('employees', 'id_card_number')->ignore($this->route('employee'))->whereNull('deleted_at')],
    ...
    public function messages(): array
    {
        return [
            ...
            'confirmation_date.after_or_equal' => 'Confirmation date cannot be before the hire date.',
            'termination_date.after_or_equal' => 'Termination/retirement date cannot be before the hire date.',
