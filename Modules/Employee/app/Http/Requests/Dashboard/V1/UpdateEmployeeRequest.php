...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_cards.*.id' => ['nullable', 'integer'],
            'id_cards.*.label' => ['nullable', 'string', 'max:100'],
            'id_cards.*.card_number' => ['nullable', 'string', 'max:100'],
            ...
            'id_cards.*.expiry_date' => ['nullable', 'date'],
            'id_cards.*.is_primary' => ['nullable', 'boolean'],
            'id_cards.*.sort_order' => ['nullable', 'integer'],
            ...
            'family_members.*.id' => ['nullable', 'integer', 'exists:employee_family_members,id'],
            ...
            'job_experiences.*.id' => ['nullable', 'integer', 'exists:employee_job_experiences,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'id_cards.*.issued_date.before_or_equal' => 'ID card issued date cannot be in the future.',
